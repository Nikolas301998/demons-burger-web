...
const Hero: React.FC = () => {
  ...
  return (
    <div className="relative h-screen w-full overflow-hidden flex items-end justify-center pb-12 md:pb-20">
      ...
      {/* TEXTO SUPERIOR: Ahora visible en PC y Celular */}
      <div className="absolute top-[5%] left-0 w-full flex flex-col items-center justify-center z-10">
        ...
        >
          ...
          <h2 className="text-4xl md:text-6xl font-black text-white italic tracking-tighter uppercase leading-none drop-shadow-xl">
            SABOR <br />
      ...
      {/* CONTENIDO PRINCIPAL (Botones e Iconos) */}
